...
const { ticketsCollection, nqnCollection, welcomeCollection, giveawayCollection, autoroleCollection, serverConfigCollection, antisetupCollection } = require('../../mongodb');
